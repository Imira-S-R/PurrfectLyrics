...
import { Search, Music, User, SearchX } from "lucide-react";
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-center px-4 sm:px-8 py-4 border-b border-white/5">
        <span className="font-semibold text-xl sm:text-2xl tracking-tight hover:cursor-pointer" onClick={() => navigate('/')}>
          PurrfectLyrics
        </span>
      </nav>
